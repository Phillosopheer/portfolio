            ...
            >
              <div className="flex h-full flex-col justify-between pb-6 pt-1">
                ...
                <div className="mt-1 text-center">
                  {card.hasVideo ? (
                    <span className="mx-auto mb-3 flex h-20 w-20 items-center justify-center overflow-hidden rounded-xl border border-white/20 bg-black transition-all duration-300 group-hover:border-[#15ef8d]/55 group-hover:bg-[#15ef8d]/10">
                      <video
